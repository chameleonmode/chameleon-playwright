...
// Get random string from input
export const getRandomWordFromTextInput = (textInput:string) => {
  let randomString=""
  const chars = textInput.split(" ") //Split Input per word
